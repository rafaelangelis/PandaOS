...
import { createFinancialAccount, type FinancialAccountFormState } from "../actions";
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      <div className="flex flex-col gap-1">
        ...
        <input type="text" name="name" required className={inputClass} placeholder="Ex: Caixa, Nubank PJ" />
      </div>
      <div className="flex flex-col gap-1 sm:w-48">
        <label className={labelClass}>Tipo</label>
        <select name="type" defaultValue="caixa" className={inputClass}>
      ...
      <div className="flex flex-col gap-1 sm:w-48">
        ...
        <input type="text" inputMode="decimal" data-numeric="decimal" name="initialBalance" className={inputClass} />
      </div>
